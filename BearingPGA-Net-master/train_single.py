...
def inference10(net0,config):
    ...
    file = "Pth/" + "SCNN_"  + '_' + str(config.snr) + '_' +  config.chosen_data + '_' + str(round(np.mean(test_f1).item(), 2)) + ".pth"
    print(file)
...
if __name__ == '__main__':
    ...
    #wandb.init(project="888", entity="Klara Sagucio ")
    wandb.init(project="888")
